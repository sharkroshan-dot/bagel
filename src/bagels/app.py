...
class App(TextualApp):
    ...
    BINDINGS = [
        (config.CONFIG.hotkeys.toggle_jump_mode, "toggle_jump_mode", "Jump Mode"),
        (config.CONFIG.hotkeys.home.cycle_tabs, "cycle_tabs", "Cycle tabs"),
        ("ctrl+q", "quit", "Quit"),
    ]
    COMMANDS = {AppProvider}

    app_theme: Reactive[str] = reactive(config.CONFIG.state.theme, init=False)
    ...
    def compose(self) -> ComposeResult:
        ...
        if config.CONFIG.state.footer_visibility:
            yield Footer()
