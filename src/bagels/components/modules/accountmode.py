...
class AccountMode(ScrollableContainer):
    BINDINGS = [
        (config.CONFIG.hotkeys.new, "new", "New account"),
        (config.CONFIG.hotkeys.delete, "delete", "Archive account"),
        (config.CONFIG.hotkeys.edit, "edit", "Edit account"),
    ]
    ...
    def __init__(self, parent: Static, *args, **kwargs) -> None:
        ...
        super().__setattr__("border_title", "Accounts")
        super().__setattr__(
            "border_subtitle",
            f"{config.CONFIG.hotkeys.home.select_prev_account} {config.CONFIG.hotkeys.home.select_next_account}",
        )
    ...
    def rebuild(self) -> None:
        ...
        super().__setattr__(
            ...
            (
                ...
                f"{round(net_balance, config.CONFIG.defaults.round_decimals)}"
            ),
        )
